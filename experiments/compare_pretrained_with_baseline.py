...
pre_train = {
    ...
    'epochs': 1,  # Total epochs for pre-training
...
fine_tune_training_config = {
    ...
    'shuffle_train': True,
    'shuffle_test': False,
    'training_epochs': 2,  # Fine-tuning phase training epochs
...
test_visualization(fine_model_with_pre, test_loader, mask,
                   device, f"The fine-tuned model with pre-trained", "../images")
...
test_visualization(fine_model_without_pre, test_loader, mask,
                   device, f"The baseline model without pre-trained", "../images")
